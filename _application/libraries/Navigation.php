...
class Navigation {
    ...
    public function render($menu,$currentPage='home.html',$site){
        foreach ($menu as $m){
                ?>
            <?php
                if(isset($m['submenu'])){
            ...
            <li class="dropdown <?php echo $currentPage == $m['id'] ? ' active' : '';?>">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo $site['site_url'] . $m['url'];?>" class="active"><?php echo $m['title'];?></a></li>
                    <?php
                        foreach ($m['submenu'] as $submenu){
                    ?>
                        <li <?php echo $currentPage == $submenu['id'] ? 'class="active"' : '';?>>
                            <a href="<?php echo $site['site_url'] .  $submenu['url'];?>"><?php echo $submenu['title'];?></a>
                        </li>
                    <?php
                        }      
                    ?>
            ...
            <li <?php echo $currentPage == $m['id'] ? 'class="active"' : '';?>>
                <a href="<?php echo $site['site_url'] . $m['url'];?>"><?php echo $m['title'];?></a>
            </li>
            <?php }?>
            <?php
        }
